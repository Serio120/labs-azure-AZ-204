...
<!-- HEMOS AÑADIDO UNA HERRAMIENTA PARA GESTIONAR LOS STORAGES DE AZURE, SE LLAMA: --> [Explorador de Azure Storage](https://azure.microsoft.com/es-es/products/storage/storage-explorer)
